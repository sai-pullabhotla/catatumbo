...
/**
 * A factory for producing indexers. This factory ensures there is at most one
 * instance of a given Indexer implementation.
 * 
...
public class IndexerFactory {
	...
	/**
	 * Gets the {@link Indexer} for the given field. If the field has a
	 * {@link PropertyIndexer} annotation, the specified indexer will be
	 * returned. Otherwise, a default indexer will be returned based on the
	 * field's type.
	 * 
	 * @param field
	 *            the field
	...
	private Indexer getDefaultIndexer(Field field) {
		...
		String message = String.format("No default indexer found for field %s in class %s", field.getName(),
