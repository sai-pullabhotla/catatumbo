...
public class ConstructorMetadata {
  ...
  /**
   * Tells whether or not the persistence class represented by this metadata using the
   * {@link ConstructionStrategy#CLASSIC} strategy.
   * 
  ...
  /**
   * Tells whether or not the persistence class represented by this metadata using the
   * {@link ConstructionStrategy#BUILDER} strategy.
   * 
  ...
  public static class Builder {
     ...
     *          the method handle for constructing the persistence object or its builder object.
     * @return this {@code Builder} instance
     */
     ...
     *          the method handle for building the persistence object from its builder.
     * @return this {@code Builder} instance
     */
