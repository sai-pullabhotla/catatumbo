...
/**
 * A factory for creating instances of classes that are marked with
 * {@link EntityListeners} annotation. This factory ensures that there exists
 * only one instance of a given listener. Instance is created the first time it
 * is needed and then cached for subsequent uses.
 * 
