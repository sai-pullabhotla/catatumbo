 ...
 * </p>
 * <ul>
 * <li>The Customer Mapper class must implement the {@link Mapper} interface</li>
 * <li>Custom Mappers must have a public constructor with a parameter of
 * {@link java.lang.reflect.Field}.</li>
 * </ul>
 * 
 * <p>
 * Note that, unlike the built-in mappers where {@link Mapper} instances are reused where possible,
 * custom mappers are created once for each field. To clarify this further, there is only one
 * instance of {@link IntegerMapper} in the JVM that handles mapping of int/Integer fields in all
 * entities, but that's not the same case with custom mappers.
 * </p>
 * 
