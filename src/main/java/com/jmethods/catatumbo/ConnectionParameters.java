...
/**
 * Objects of this class contain various parameters that are needed for
 * connecting to the Datastore. Instances of this class can be sent to
 ...
 * stream will be used for authentication.
 * </p>
 * 
 * <p>
 ...
 * <code>setServiceURL("http://localhost:9999");</code>.
 * </p>
 * 
...
public class ConnectionParameters {
	 ...
	 * <code>http[s]://host[:port]</code>. A <code>null</code> or empty string
	 * would result in connecting to the default Datastore on GCP. All other
	 * values, except {@link ConnectionParameters#DEFAULT_SERVICE_URL}, would be
	 * interpreted as a connection to the Datastore Emulator.
	 * 
	 * @param serviceURL
	...
	/**
	 * Sets the Datastore namespace.A <code>null</code> value would be
	 * interpreted as default namespace.
	 * 
	 * @param namespace
	...
	/**
	 * Sets the Project ID.A <code>null</code> value would use the default
	 * project ID, if it can be determined from the environment.
	 * 
	 * @param projectId
	 *            the Project ID.
	 */
	...
	/**
	 * Sets the connection timeout, in milliseconds. A value of zero is
	 * interpreted as infinite timeout. A negative value implies to use the
	 * default timeout.
	 * 
	...
	/**
	 * Sets the read timeout, in milliseconds. A value of zero is interpreted as
	 * infinite timeout. A negative value implies to use the default timeout.
	 * 
	 * @param readTimeout
	...
	/**
	 * Tells whether or not these connection parameters indicate a connection to
	 * a Datastore Emulator.
	 * 
	 * @return <code>true</code>, if these connection parameters indicate a
	 *         connection to the Datastore Emulator; <code>false</code>,
	 *         otherwise.
	 */
	...
	public String toString() {
		return "ConnectionParameters [serviceURL=" + serviceURL + ", namespace=" + namespace + ", projectId="
				+ projectId + ", jsonCredentialsFile=" + jsonCredentialsFile + ", jsonCredentialsStream="
				+ jsonCredentialsStream + ", connectionTimeout=" + connectionTimeout + ", readTimeout=" + readTimeout
				+ ", httpTransportFactory=" + httpTransportFactory + ", emulator=" + isEmulator() + "]";
	}
