...
public class IntrospectionUtilsTest {
  ...
  public void testFindStaticMethod() {
    MethodHandle mh = IntrospectionUtils.findStaticMethod(ImmutablePhone.class, "newBuilder",
        Object.class);
    assertNotNull(mh);
  }
  ...
  public void testFindInstanceStaticMethod() {
    MethodHandle mh = IntrospectionUtils.findInstanceMethod(ImmutablePhone.class, "getCountryCode",
        String.class);
    assertNotNull(mh);
  }
  ...
  public void testFindInstanceStaticMethod2() {
    MethodHandle mh = IntrospectionUtils.findInstanceMethod(ImmutablePhone.Builder.class,
        "setCountryCode", null, String.class);
    assertNotNull(mh);
  }
