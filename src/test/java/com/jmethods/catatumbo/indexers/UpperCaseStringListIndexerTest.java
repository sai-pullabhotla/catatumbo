...
public class UpperCaseStringListIndexerTest {
	...
	private static final Logger LOGGER = Logger.getLogger(UpperCaseStringListIndexerTest.class.getName());
	...
	public void testIndex_3() {
		...
		assertEquals(((StringValue) inputList.get(0)).get().toUpperCase(Locale.ENGLISH), outputList.get(0).get());
