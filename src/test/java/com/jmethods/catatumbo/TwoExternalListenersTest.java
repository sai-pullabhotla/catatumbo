...
import com.jmethods.catatumbo.entities.ExternalCalculatorEntity2;

/**
 * @author Sai Pullabhotla
 *
 */
public class TwoExternalListenersTest {
  ...
  public void testPreAndPostInsert() {
    ExternalCalculatorEntity2 entity = new ExternalCalculatorEntity2(7, 5);
  ...
  public void testPreAndPostInsert_List() {
    List<ExternalCalculatorEntity2> entities = new ArrayList<>();
    for (int i = 0; i < 2; i++) {
      ExternalCalculatorEntity2 entity = new ExternalCalculatorEntity2(i + 2, i + 4);
      entities.add(entity);
    }
  ...
  public void testPreAndPostUpdate() {
    ExternalCalculatorEntity2 entity = new ExternalCalculatorEntity2();
    entity = em.insert(entity);
  ...
  public void testPreAndPost_Update_List() {
    List<ExternalCalculatorEntity2> entities = new ArrayList<>();
    for (int i = 0; i < 2; i++) {
      ExternalCalculatorEntity2 entity = new ExternalCalculatorEntity2(i, i + 1);
      entities.add(entity);
    }
    entities = em.insert(entities);
  ...
  public void testPreAndPostUpsert() {
    ExternalCalculatorEntity2 entity = new ExternalCalculatorEntity2(8, 8);
  ...
  public void testPreAndPostUpsert_List() {
    List<ExternalCalculatorEntity2> entities = new ArrayList<>();
    for (int i = 0; i < 2; i++) {
      ExternalCalculatorEntity2 entity = new ExternalCalculatorEntity2(i + 6, i + 2);
      entities.add(entity);
    }
  ...
  public void testPreAndPostDelete_List() {
    List<ExternalCalculatorEntity2> entities = new ArrayList<>();
    for (int i = 0; i < 2; i++) {
      ExternalCalculatorEntity2 entity = new ExternalCalculatorEntity2(i + 1, i + 1);
      entities.add(entity);
    }
    entities = em.insert(entities);
    em.delete(entities);
  ...
  public void testPostLoad() {
    ExternalCalculatorEntity2 entity = new ExternalCalculatorEntity2(6, 9);
    entity = em.insert(entity);
    entity = em.load(ExternalCalculatorEntity2.class, entity.getId());
  ...
  public void testPreAndPostLoad_List() {
    List<ExternalCalculatorEntity2> entities = new ArrayList<>();
    for (int i = 0; i < 2; i++) {
      ExternalCalculatorEntity2 entity = new ExternalCalculatorEntity2(i + 5, i + 6);
      entities.add(entity);
    }
    entities = em.insert(entities);
    List<Long> ids = new ArrayList<>();
    for (ExternalCalculatorEntity2 entity : entities) {
      ids.add(entity.getId());
    }
    entities = em.loadById(ExternalCalculatorEntity2.class, ids);
  ...
  public void testPreAndPostLoad_Query() {
    ...
    ExternalCalculatorEntity2 entity = new ExternalCalculatorEntity2(8, 9);
    entity = em.insert(entity);
    try {
      Thread.sleep(5000);
    ...
    EntityQueryRequest request = em.createEntityQueryRequest(String.format(
        "SELECT * FROM %s WHERE __key__=@1", ExternalCalculatorEntity2.class.getSimpleName()));
