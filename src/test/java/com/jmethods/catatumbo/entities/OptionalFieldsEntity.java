...
public class OptionalFieldsEntity {
  ...
  public boolean equalsExceptId(Object obj) {
    ...
    return Objects.equals(this.mandatoryString, that.mandatoryString)
        ...
        && Objects.equals(this.optionalPhone, that.optionalPhone)
  ...
  public String toString() {
    ...
    builder.append("OptionalFieldsEntity [id=").append(id).append(", mandatoryString=")
        .append(mandatoryString).append(", key=").append(key).append(", optionalShort=")
        .append(optionalShort).append(", optionalInteger=").append(optionalInteger)
        .append(", optionalLong=").append(optionalLong).append(", optionalString=")
        .append(optionalString).append(", optionalDate=").append(optionalDate)
        ...
        .append(optionalMap).append(", optionalPhone=").append(optionalPhone).append(", fax=")
        .append(fax).append(", optionalAddress=").append(optionalAddress).append("]");
