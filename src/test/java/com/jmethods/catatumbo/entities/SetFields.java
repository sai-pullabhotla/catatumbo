...
public class SetFields {
  ...
  public boolean equals(Object obj) {
    ...
    return this.id == that.id && Objects.equals(this.booleanSet, that.booleanSet)
        ...
        && Objects.equals(this.shortSet, that.shortSet) && Objects.equals(this.intSet, that.intSet)
        && Objects.equals(this.longSet, that.longSet)
        && Objects.equals(this.floatSet, that.floatSet)
        && Objects.equals(this.doubleSet, that.doubleSet)
        && Objects.equals(this.stringSet, that.stringSet) && Objects.equals(this.enumSet, enumSet)
        && Objects.equals(this.dateSet, that.dateSet)
        && Objects.equals(this.calendarSet, that.calendarSet)
        && Objects.equals(this.geoLocationSet, that.geoLocationSet)
        && Objects.equals(this.keySet, that.keySet)
        && Objects.equals(this.objectSet, that.objectSet)
        && Objects.equals(this.hashSet, that.hashSet)
        && Objects.equals(this.sortedSet, that.sortedSet)
        && Objects.equals(this.linkedHashSet, that.linkedHashSet)
        && Objects.equals(this.treeSet, that.treeSet)
  ...
  public static SetFields getSampleEntity1() {
    ...
    entity.setDateSet(new HashSet<>(
        Arrays.asList(new Date(), new Date(System.currentTimeMillis() + 60000), null)));
    entity.setCalendarSet(
        new HashSet<>(Arrays.asList(Calendar.getInstance(), null, Calendar.getInstance())));
    ...
    entity.setGeoLocationSet(new HashSet<>(Arrays.asList(new GeoLocation(40.7142700, -74.0059700),
        new GeoLocation(48.8534100, 2.3488000))));
    entity.setObjectSet(
        new HashSet<>(Arrays.asList("One", 5000L, 99.99d, Boolean.FALSE, (String) null)));
    entity.setHashSet(new HashSet<>(Arrays.asList("Whatever", "Let's see", null)));
    entity.setSortedSet(new TreeSet<>(Arrays.asList(5, 1, 3)));
    entity.setLinkedHashSet(
        new LinkedHashSet<>(Arrays.asList(Double.MIN_VALUE, 0.0, Double.MAX_VALUE)));
