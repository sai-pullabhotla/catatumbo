...
public class ImmutablePerson {
	...
	public String toString() {
		...
		builder2.append("ImmutablePerson [id=").append(id).append(", name=").append(name).append(", address=")
				.append(address).append(", key=").append(key).append(", phoneNumber=").append(phoneNumber)
				.append(", otherNumbers=").append(otherNumbers).append(", modifiedOn=").append(modifiedOn).append("]");
	...
	public static ImmutablePerson getSample1() {
		...
		ImmutablePerson person = ImmutablePerson.newBuilder().withName("John Doe")
				...
				.phoneNumber(ImmutablePhone.getSample1()).setOtherNumbers(ImmutablePhone.getSampleList()).build();
		return person;
	}
