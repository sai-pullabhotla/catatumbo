...
public class AccessorTestEntity {
  ...
  public boolean equalsExceptId(AccessorTestEntity that) {
    return this.$$$ == that.$$$ && this.$12 == that.$12 && this.$name == that.$name
        && this.__ == that.__ && this._a == that._a && this._eventId == that._eventId
        && this.a == that.a && this.a1 == that.a1 && this.ab == that.ab
        && this.IPAddress == that.IPAddress && this.myLongVariableName == that.myLongVariableName
        && this.URL == that.URL && this.xY == that.xY;
  }
