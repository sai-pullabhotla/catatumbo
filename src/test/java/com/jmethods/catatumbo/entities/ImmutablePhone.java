...
public class ImmutablePhone {
	...
	public String toString() {
		...
		builder2.append("ImmutablePhone [countryCode=").append(countryCode).append(", areaCode=").append(areaCode)
				.append(", subscriberNumber=").append(subscriberNumber).append("]");
	...
	public static ImmutablePhone getSample1() {
		return ImmutablePhone.newBuilder().setAreaCode("4").setAreaCode("20").setSubscriberNumber("98765432").build();
	}

	public static ImmutablePhone getSample2() {
		return ImmutablePhone.newBuilder().setAreaCode("91").setAreaCode("040").setSubscriberNumber("1122334455")
				.build();
	}

	public static ImmutablePhone getSample3() {
		return ImmutablePhone.newBuilder().setAreaCode("91").setAreaCode("080").setSubscriberNumber("9988776655")
				.build();
	}
