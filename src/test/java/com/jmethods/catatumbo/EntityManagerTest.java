...
import com.jmethods.catatumbo.entities.ImmutableSubClass;
...
public class EntityManagerTest {
  ...
  public void testInsertCalendarField() {
    ...
    assertTrue(
        entity.getId() > 0 && entity.getCreationDate().getTimeInMillis() == now.getTimeInMillis());
  }
  ...
  public void testInsertParentChild() {
    ...
    assertTrue(child.getParentKey().equals(parent.getKey())
        && grandchild.getParentKey().equals(child.getKey()));
  }
  ...
  public void testInsert_IgnoredField() {
    ...
    assertTrue(
        entity.getId() > 0 && entity.getName().equals("John Doe") && entity.getComputed() == null);
  }
  ...
  public void testUpdate_IgnoredField() {
    ...
    em.update(entity);
    entity = em.load(IgnoreField.class, entity.getId());
    assertTrue(entity.getId() > 0 && entity.getName().equals("John Smith")
        && entity.getComputed() == null);
  }
  ...
  public void testDelete_Grandchild() {
    ...
    GrandchildEntity grandchild2 = em.load(GrandchildEntity.class, child.getKey(),
        grandchild.getId());
    assertTrue(grandchild != null && grandchild2 == null);
  }

  /*
   * @Test public void testDeleteAll() { List<DeleteAll> entities = new ArrayList<>(); for (int i =
   * 0; i < 5; i++) { DeleteAll entity = new DeleteAll(); entity.setField1("Delete All " + i);
   * entities.add(entity); } em.insert(entities); try { Thread.sleep(5000L); } catch
  ...
  public void testLoad_ParentChild() {
    ...
    GrandchildEntity grandchild2 = em.load(GrandchildEntity.class, child2.getKey(),
        grandchild.getId());

    assertTrue(grandchild.getId() == grandchild2.getId()
        && grandchild.getField1().equals(grandchild2.getField1())
  ...
  public void testLoad_IgnoredField() {
    ...
    assertTrue(entity.getId() == entity2.getId() && entity.getComputed() != null
        && entity2.getComputed() == null);
  }
  ...
  public void executeTest_SelectAll() {
    ...
    assertTrue(tasks.size() == 50 && tasks.get(0).getId() == 1
        && tasks.get(tasks.size() - 1).getId() == 50);
  }
  ...
  public void rexecuteTest_SelectPriorityFilter() {
    ...
    QueryResponse<Task> response = em.executeEntityQueryRequest(Task.class, request);
    List<Task> tasks = response.getResults();
    assertTrue(tasks.size() == 10 && tasks.get(0).getId() == 5
        && tasks.get(tasks.size() - 1).getId() == 50);
  }
  ...
  public void executeTest_SelectPriorityAndCompleteFilter() {
    EntityQueryRequest request = em.createEntityQueryRequest(
        "SELECT * FROM Task WHERE priority = @1 AND complete = @2 order by __key__");
    request.addPositionalBinding(0);
    request.addPositionalBinding(true);
    QueryResponse<Task> response = em.executeEntityQueryRequest(Task.class, request);
    List<Task> tasks = response.getResults();
    assertTrue(tasks.size() == 5 && tasks.get(0).getId() == 10
        && tasks.get(tasks.size() - 1).getId() == 50);
  }
  ...
  public void executeTest_SelectTaskNameFilter() {
    EntityQueryRequest request = em
        .createEntityQueryRequest("SELECT * FROM Task WHERE name = @1 order by __key__");
  ...
  public void executeTest_SelectTasksDueByTomorrow() {
    ...
    EntityQueryRequest request = em
        .createEntityQueryRequest("SELECT * FROM Task WHERE completionDate <= @1");
  ...
  public void testExecute_PositionalBinding() {
    EntityQueryRequest request = em
        .createEntityQueryRequest("SELECT * from Task WHERE priority=@1");
  ...
  public void testExecute_GeoLocation() {
    ...
    em.insert(cdg);
    EntityQueryRequest request = em
        .createEntityQueryRequest("SELECT * FROM CityCoordinates ORDER BY city");
    QueryResponse<GeoLocationField> response = em.executeEntityQueryRequest(GeoLocationField.class,
        request);
  ...
  public void testExecuteProjectionQuery() {
    ...
    for (Task task : tasks) {
      System.out.printf("Id: %d; Name: %s; Priority: %s; Complete: %s; Completion Date: %s\n",
          task.getId(), task.getName(), task.getPriority(), task.isComplete(),
  ...
  public void testInsert_OptimisticLock1_Multiple() {
    ...
    assertTrue(insertedEntities.get(0).getVersion() == 1
        && insertedEntities.get(1).getVersion() == 1 && insertedEntities.get(2).getVersion() == 1
        && insertedEntities.get(3).getVersion() == 1 && insertedEntities.get(4).getVersion() == 1);
  }
  ...
  public void testUpdateTimestamp_OffsetDateTime() {
    ...
    entity.setName("Insert");
    AutoTimestampOffsetDateTime entity2 = em.insert(entity);
    AutoTimestampOffsetDateTime entity3 = em.load(AutoTimestampOffsetDateTime.class,
        entity2.getId());
    entity3.setName("Update");
  ...
  public void testQueryByLocalDate_PositionalBinding() {
    ...
    QueryResponse<LocalDateField> response = em.executeEntityQueryRequest(LocalDateField.class,
        request);
  ...
  public void testQueryByLocalTime_PositionalBinding() {
    ...
    QueryResponse<LocalTimeField> response = em.executeEntityQueryRequest(LocalTimeField.class,
        request);
  ...
  public void testQueryByLocalDateTime_PositionalBinding() {
    ...
    QueryResponse<LocalDateTimeField> response = em
        .executeEntityQueryRequest(LocalDateTimeField.class, request);
  ...
  public void testQueryByOffsetDateTime_PositionalBinding() {
    ...
    OffsetDateTimeField entity = new OffsetDateTimeField();
    OffsetDateTime timestamp = OffsetDateTime.of(2007, 1, 12, 10, 30, 3, 456789012,
        ZoneOffset.of("Z"));
    entity.setTimestamp(timestamp);
    entity = em.insert(entity);
    ...
    EntityQueryRequest request = em.createEntityQueryRequest(query);
    request.addPositionalBindings(timestamp);
    QueryResponse<OffsetDateTimeField> response = em
        .executeEntityQueryRequest(OffsetDateTimeField.class, request);
  ...
  public void testQueryByZonedDateTime_PositionalBinding() {
    ...
    ZonedDateTimeField entity = new ZonedDateTimeField();
    ZonedDateTime timestamp = ZonedDateTime.of(2007, 1, 12, 10, 30, 3, 456789012,
        ZoneOffset.of("Z"));
    entity.setTimestamp(timestamp);
    entity = em.insert(entity);
    ...
    EntityQueryRequest request = em.createEntityQueryRequest(query);
    request.addPositionalBindings(timestamp);
    QueryResponse<ZonedDateTimeField> response = em
        .executeEntityQueryRequest(ZonedDateTimeField.class, request);
  ...
  public void testUpdate_WrappedLongObjectIdEntity() {
    ...
    WrappedLongObjectIdEntity entity4 = em.load(WrappedLongObjectIdEntity.class,
        entity3.getId().getValue());
    assertEquals(entity3, entity4);
  }
  ...
  @Test
  public void testInsert_ImmutablePerson() {
    ImmutablePerson entity = ImmutablePerson.getSample1();
    ...
    // Checks listeners
    assertTrue(entity.isPreInsertFired());
    assertFalse(entity.isPostInsertFired());
    assertFalse(entity.isPostLoadFired());

    assertTrue(entity2.isPostInsertFired());
    assertFalse(entity2.isPreInsertFired());
    assertFalse(entity2.isPostLoadFired());

    assertTrue(entity3.isPostLoadFired());
    assertFalse(entity3.isPreInsertFired());
    assertFalse(entity3.isPostInsertFired());

  }

  @Test
  public void testInsert_ImmutablePerson_AllNulls() {
  ...
  @Test
  public void testInsert_ImmutableSubClass() {
    ImmutableSubClass entity = ImmutableSubClass.newBuilder().setName("Immutable SubClass").build();
    ImmutableSubClass entity2 = em.insert(entity);
    ImmutableSubClass entity3 = em.load(ImmutableSubClass.class, entity2.getId());
    assertTrue(entity.equalsExceptGeneratedValues(entity2));
    assertEquals(entity2, entity3);
  }

  @Test
  public void testUpdate_ImmutableSubClass() {
    ImmutableSubClass entity = ImmutableSubClass.newBuilder()
        .setName("Immutable SubClass for Update").build();
    ImmutableSubClass entity2 = em.insert(entity);
    ImmutableSubClass entity3 = em.update(entity2);
    ImmutableSubClass entity4 = em.load(ImmutableSubClass.class, entity2.getId());
    assertTrue(entity.equalsExceptGeneratedValues(entity2));
    assertEquals(0L, entity2.getVersion());
    assertEquals(1L, entity3.getVersion());
    assertEquals(entity3, entity4);
  }

  @Test
  public void testDelete_ImmutableSubClass() {
    ImmutableSubClass entity = ImmutableSubClass.newBuilder()
        .setName("Immutable SubClass for Delete").build();
    ImmutableSubClass entity2 = em.insert(entity);
    ImmutableSubClass entity3 = em.load(ImmutableSubClass.class, entity2.getId());
    em.delete(entity3);
