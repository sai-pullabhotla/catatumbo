...
public class EntityManagerTest {
	...
	public void testUpdate_ImmutableSubClass() {
		ImmutableSubClass entity = ImmutableSubClass.newBuilder().setName("Immutable SubClass for Update").build();
		ImmutableSubClass entity2 = em.insert(entity);
	...
	public void testDelete_ImmutableSubClass() {
		ImmutableSubClass entity = ImmutableSubClass.newBuilder().setName("Immutable SubClass for Delete").build();
		ImmutableSubClass entity2 = em.insert(entity);
		ImmutableSubClass entity3 = em.load(ImmutableSubClass.class, entity2.getId());
		em.delete(entity3);
