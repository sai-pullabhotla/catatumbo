...
import com.jmethods.catatumbo.entities.ExternalCalculatorEntity4;
 ...
 *
 */
public class DefaultAndExternalListenersTest {
  ...
  public void testPreAndPostInsert() {
    ExternalCalculatorEntity4 entity = new ExternalCalculatorEntity4(7, 5);
    ...
    assertTrue(entity.getDifference2() == 4);
  }

  @Test
  public void testPreAndPostInsert_List() {
    List<ExternalCalculatorEntity4> entities = new ArrayList<>();
    for (int i = 0; i < 2; i++) {
      ExternalCalculatorEntity4 entity = new ExternalCalculatorEntity4(i + 2, i + 4);
      entities.add(entity);
    }
    ...
    assertTrue(entities.get(0).getDifference2() == -4);
    assertTrue(entities.get(1).getDifference() == -2);
    assertTrue(entities.get(1).getDifference2() == -4);
  }

  @Test
  public void testPreAndPostUpdate() {
    ExternalCalculatorEntity4 entity = new ExternalCalculatorEntity4();
    entity = em.insert(entity);
    ...
    assertTrue(entity.getDifference2() == 21);
  }
  ...
  public void testPreAndPost_Update_List() {
    List<ExternalCalculatorEntity4> entities = new ArrayList<>();
    for (int i = 0; i < 2; i++) {
      ExternalCalculatorEntity4 entity = new ExternalCalculatorEntity4(i, i + 1);
      entities.add(entity);
    }
    entities = em.insert(entities);
    ...
    assertTrue(entities.get(0).getDifference2() == -3);
    assertTrue(entities.get(1).getDifference() == -1);
    assertTrue(entities.get(1).getDifference2() == -3);
  }

  @Test
  public void testPreAndPostUpsert() {
    ExternalCalculatorEntity4 entity = new ExternalCalculatorEntity4(8, 8);
    ...
    assertTrue(entity.getDifference2() == 0);
  }
  ...
  public void testPreAndPostUpsert_List() {
    List<ExternalCalculatorEntity4> entities = new ArrayList<>();
    for (int i = 0; i < 2; i++) {
      ExternalCalculatorEntity4 entity = new ExternalCalculatorEntity4(i + 6, i + 2);
      entities.add(entity);
    }
    ...
    assertTrue(entities.get(0).getDifference2() == 16);
    assertTrue(entities.get(1).getDifference() == 4);
    assertTrue(entities.get(1).getDifference2() == 16);
  }
  ...
  public void testPreAndPostDelete() {
    ...
    assertTrue(entity.getDifference2() == -5);
  }
  ...
  public void testPreAndPostDelete_List() {
    List<ExternalCalculatorEntity4> entities = new ArrayList<>();
    for (int i = 0; i < 2; i++) {
      ExternalCalculatorEntity4 entity = new ExternalCalculatorEntity4(i + 1, i + 1);
      entities.add(entity);
    }
    entities = em.insert(entities);
    em.delete(entities);
    ...
    assertTrue(entities.get(0).getDifference2() == 0);
    assertTrue(entities.get(1).getDifference() == 0);
    assertTrue(entities.get(1).getDifference2() == 0);
  }

  @Test
  public void testPostLoad() {
    ExternalCalculatorEntity4 entity = new ExternalCalculatorEntity4(6, 9);
    entity = em.insert(entity);
    entity = em.load(ExternalCalculatorEntity4.class, entity.getId());
    ...
    assertTrue(entity.getDifference2() == -18);
  }
  ...
  public void testPreAndPostLoad_List() {
    List<ExternalCalculatorEntity4> entities = new ArrayList<>();
    for (int i = 0; i < 2; i++) {
      ExternalCalculatorEntity4 entity = new ExternalCalculatorEntity4(i + 5, i + 6);
      entities.add(entity);
    }
    entities = em.insert(entities);
    List<Long> ids = new ArrayList<>();
    for (ExternalCalculatorEntity4 entity : entities) {
      ids.add(entity.getId());
    }
    entities = em.loadById(ExternalCalculatorEntity4.class, ids);
    ...
    assertTrue(entities.get(0).getDifference() == -1);
    assertTrue(entities.get(0).getDifference2() == -6);
    assertTrue(entities.get(1).getDifference() == -1);
    assertTrue(entities.get(1).getDifference2() == -6);
  }
  ...
  public void testPostLoad_Query() {
    ...
    EntityQueryRequest request = em.createEntityQueryRequest(String.format(
        "SELECT * FROM %s WHERE __key__ = @1", ExternalCalculatorEntity4.class.getSimpleName()));
